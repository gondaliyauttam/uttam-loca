...
class ShareBookingImage extends StatefulWidget {
  final Booking data;

  const ShareBookingImage({Key key, this.data}) : super(key: key);

  @override
  _ShareBookingImageState createState() => _ShareBookingImageState();
}

class _ShareBookingImageState extends State<ShareBookingImage> {
  Booking booking;
                      ...
                      child: Card(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              child: booking.affirmation != null
                                  ? CachedNetworkImage(
                                      width: 150,
                                      imageUrl: booking.affirmation.entryQr,
