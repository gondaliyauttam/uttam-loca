...
import 'package:loca_bird/src/elements/ShareAffirmationImage.dart';
import 'package:loca_bird/src/models/affirmation.dart';
import 'package:loca_bird/src/repository/user_repository.dart';


class AffirmationTicketWidget extends StatelessWidget {
  final Affirmation data;

  const AffirmationTicketWidget({Key key, this.data}) : super(key: key);
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                child: data.entryQr != null
                    ? CachedNetworkImage(
                  width: 100,
                  imageUrl: data.entryQr,
                  ...
                  children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            ...
                            /*  String text = currentUser.name +
                                  ...
                                  " : " +
                                  data.personCount.toString()+ "\n" + data.entryQr;*/

                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ShareAffirmationImage(data: data)),
                              );
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Text(
                          S.of(context)
                              .note__please_show_this_code_while_entering,
 ...
 /* Future shareImage(String imageUrl, String text) async {
    ...
    return Share.file('image.png',"", bytes,text=text);
  }*/
