...
import 'package:loca_bird/src/elements/Location_type_widget.dart';
import 'package:loca_bird/src/elements/DrawerWidget.dart';
import 'package:loca_bird/src/elements/FoodsCarouselWidget.dart';
import 'package:loca_bird/src/elements/GridWidget.dart';
import 'package:loca_bird/src/elements/ReviewsListWidget.dart';
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    S.of(context).location_types,
                    style: Theme.of(context).textTheme.display1,
                  ),
                ),
              ),
              LocationTypeWidget(
                  locationtypes: _con.locationType,
                  heroTag: 'home_locationType'),
              /* Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: ListTile(
                  dense: true,
