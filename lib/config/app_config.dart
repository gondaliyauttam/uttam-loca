...
//  Color _mainColor = Color(0xFFFF4E6A);
  Color _mainColor = Color(0xFF0F52BA);
  Color _mainDarkColor = Color(0xFFFCC000);
  Color _secondColor = Color(0xFFE3F2FD);
  ...
  Color _scaffoldDarkColor = Color(0xFF272727);
